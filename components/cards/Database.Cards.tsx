      ...
      <div className="grid grid-cols-3 gap-4 my-4">
        {Data.map((item) => (
          <Link href={item.url} key={item.id} target="_blank" className="">
            <div
              className="group border border-white/10 px-20 h-14 rounded-lg flex flex-wrap hover:border-white/25 hover:bg-neutral-900 relative overflow-hidden justify-center items-center content-center duration-300"
