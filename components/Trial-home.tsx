...
const components: { title: string; href: string; description: string }[] = [
  {
    title: "Course",
    href: "/course",
    description: "Free and complete courses using the latest libraries.",
  },
  {
    title: "Tutorial",
    href: "/tutorial",
    description: "Features lessons on building components, ubuntu and more",
  },
  {
    title: "Library",
    href: "/library",
    description: "A collection of ui components, free hosting, javascript libraries and more.",
  },
  {
    title: "Scroll-area",
        ...
        <header className="mb-8 border-b">
          <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-4 md:px-8">
            ...
            <NavigationMenu className="hidden lg:flex">
              <NavigationMenuList>
                <NavigationMenuItem>
                  <NavigationMenuTrigger className="group-hover:text-cyan-600">Getting started</NavigationMenuTrigger>
                  <NavigationMenuContent>
                ...
                <NavigationMenuItem>
                  <NavigationMenuTrigger>Application</NavigationMenuTrigger>
                  <NavigationMenuContent>
